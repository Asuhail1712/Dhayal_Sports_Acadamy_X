    ...
    <section id="home" ref={containerRef} className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col items-center justify-center mt-10 sm:mt-4">
        <motion.div
          ...
          className="mb-4 inline-flex max-w-[18rem] items-center justify-center gap-2 px-3 sm:max-w-none sm:px-4 py-2 rounded-full bg-background/70 backdrop-blur-md border border-primary/30"
        >
        ...
        >
          ...
          <Button size="default" variant="outline" className="w-full sm:w-auto text-[15px] sm:text-base h-11 px-7 rounded-full bg-background/70 backdrop-blur-md border border-white/10 text-white hover:bg-white/10" asChild>
            <a href="#about">
              About Academy
            </a>
          </Button>
      ...
      >
        <div className="bg-background/70 backdrop-blur-md border border-white/10 rounded-2xl py-4 flex items-center justify-evenly divide-x divide-white/10">
